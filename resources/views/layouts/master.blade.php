...
<head>
    ...
    <title>Lara-POS | Dashboard</title>
    ...
    <!-- Daterange picker -->
    <link rel="stylesheet"
        href="{{ asset('Dashboard/bower_components/bootstrap-daterangepicker/daterangepicker.css') }}">
...
<body class="hold-transition skin-blue-light sidebar-mini">
    ...
    <!-- datepicker -->
    <script src="{{ asset('Dashboard/bower_components/bootstrap-datepicker/dist/js/bootstrap-datepicker.min.js') }}">
    </script>
    <!-- Bootstrap WYSIHTML5 -->
